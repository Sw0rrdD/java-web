...
public final class SqlHelper {
		...
		try {
			...
			while (rs.next()) {
				Object[] objects = new Object[column];
				 System.out.println("sqlhelper："  + rs.getObject(1) + "  " );
	...
	public ResultSet executeQueryRs(String sql, String[] parameters) {
	...
	public boolean executeQueryBo(String sql, String[] parameters) {
