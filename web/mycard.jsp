	...
	<div class="content">
		...
		<div class="sidebar">
			...
			<ul id="nav">
				...
				<li><a href="mycard.jsp" class="open"><i class="icon-bar-chart"></i> 我的账户</a>
				</li>
		...
		<div class="mainbar">
			...
			<div class="page-head">
				<h2 class="pull-left">
					<i class="icon-table"></i> 我的账户
				</h2>
			<div class="bread-crumb pull-right">
	          <a href="newcard.jsp">创建新账户 </a> &nbsp&nbsp&nbsp <a href="delcard.jsp">删除账户</a> 
	        </div>
								...
								<div class="widget-content">
									...
									<table class="table table-striped table-bordered table-hover">
										...
										<tbody>
											...
											%>
											<tr>
												<td><%=list.get(i).getCardnumber()%></td>
												<td><%=list.get(i).getMoney()%></td>
												<td><%=list.get(i).getCreattime()%></td>
												<td>
													<%
														if (list.get(i).getIsonuse() == 1) {
													%> <span
													class="label label-success">有效</span> <%
 													} else {
 													%> 
 													<span class="label label-danger">停用</span></td>
												<%
													}
												%>
											</tr>
