	              ...
	              <div class="widget wgreen">
	                ...
	                <div class="widget-content">
	                  <div class="padd">
	                    ...
	                    <hr />
	                    <!-- Form starts.  -->
	                     <form action="newcard" method="post" class="form-horizontal" role="form">                           
	                               	  	                                
	                                <div class="form-group">
	                                  <label class="col-lg-4 control-label">账户金额</label>
	                                  <div class="col-lg-7">
	                                    <input type="text" class="form-control" name="money" placeholder="账户金额">
	                                  </div>
	                                </div>
	                                <div class="form-group">
