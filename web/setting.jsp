		...
		<div class="mainbar">
			...
			<form action="modify" method="post" class="form-horizontal">
	                    <!-- Registration form starts -->
	                                          ...
	                                          <!-- Password -->
	                                          <div class="form-group">
	                                            <label class="control-label  col-lg-5" for="OldSuperPassword">原取款密码</label>
	                                            <div class="col-lg-9">
	                                              <input type="password" class="form-control" id="oldsuperpassword" name="oldsuperpassword">
	                                            </div>
	                                          </div>
	                                          <!-- SuperPassword -->
	                                          <div class="form-group">
	                                            <label class="control-label col-lg-4" for="NewSuperPassword">新取款密码</label>
	                                            <div class="col-lg-9">
	                                              <input type="password" class="form-control" id="newsuperpassword" name="newsuperpassword">
	                                            </div>
	                                          </div>
