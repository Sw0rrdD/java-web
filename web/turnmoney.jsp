	...
	<div class="content">
		...
		<div class="sidebar">
			...
			<ul id="nav">
				...
				<li><a href="turnmoney.jsp" class="open"><i class="icon-tasks"></i> 转账功能</a>
				</li>
			</ul>
		</div>
		<!-- Sidebar ends -->
	              ...
	              <div class="widget wgreen">
	                ...
	                <div class="widget-content">
	                  <div class="padd">
	                    ...
	                    <hr />
	                    <!-- Form starts.  -->
	                     <form action="turnmoney" method="post" class="form-horizontal" role="form">                           
	                               	   <div class="form-group">
	                                  <label class="col-lg-8 control-label">本地账户</label>
	                                  <div class="col-lg-7">
	                                ...
	                                <div class="form-group">
	                                  <label class="col-lg-4 control-label">目标账户</label>
	                                  <div class="col-lg-7">
	                                    <input type="text" class="form-control" name="tocardnumber" placeholder="目标账户">
	                                  </div>
	                                </div>
	                                ...
	                                <div class="form-group">
	                                  ...
	                                  <div class="col-lg-7">
	                                    <input type="text" class="form-control" name="getmoney" placeholder="转账金额">
	                                  </div>
	                                </div>
